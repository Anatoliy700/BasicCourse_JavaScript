...
//TODO: Новый объект счетчика игры.
/**
...
const game = {
  ...
  //TODO: Добавлено свойство ссылающееся на объект счетчика.
  score,
  tickInterval: null,
  ...
  init(settings = {}) {
    ...
    //TODO: Добавлен вызов метода объекта счетчик.
